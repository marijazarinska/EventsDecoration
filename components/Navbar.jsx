    ...
    return (
        <div style={{backgroundColor:'${color}'}} className=" fixed left-0 top-0 w-full z-10 ease-in duration-300">
            <div className="max-w-[1240px] m-auto flex justify-between items-center p-4 text-white">
                <Link href='/'> 
                <h1 style={{color:'${textColor}'}} className="font-bold text-3xl">YoursTruly</h1>
                </Link>
                ...
                {/*mobile button */}
                <div onClick={handleNav} className=" block sm:hiden z-10 ">
                   {nav ? <AiOutlineClose className="lg:hidden md:hidden"  size={20} style={{color:'${textColor}'}}  /> : <AiOutlineMenu className="lg:hidden md:hidden" size={20} style={{color:'${textColor}'}}/>}
                </div>
                {/*mobile menu*/}
